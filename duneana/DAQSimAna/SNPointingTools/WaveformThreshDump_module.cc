// trying out the new version of the module
...
} // WaveformThreshDump constructor
...
void WaveformThreshDump::ResetVariables()
{
  MarleyMap.clear();
...
void WaveformThreshDump::FillMyMaps(std::map<int, simb::MCParticle> &MyMap,
				    art::FindManyP<simb::MCParticle> Assn, 
				    art::Handle< std::vector<simb::MCTruth> > Handle, 
...
PType WaveformThreshDump::WhichParType (int TrkID)
{
...
//......................................................
void WaveformThreshDump::analyze(art::Event const & evt)
{
  ...
  for(size_t hit = 0; hit < digits_handle->size(); ++hit) {
    ...
    std::vector<short> waveform = digits_handle->at(hit).ADCs();
